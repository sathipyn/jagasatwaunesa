<div class="rounded-[1.75rem] border border-gray-100 bg-white p-6 shadow-sm sm:p-7">
    <div class="flex flex-col gap-2 border-b border-gray-100 pb-5 sm:flex-row sm:items-end sm:justify-between">
        <div>
            <h2 class="text-2xl font-extrabold text-pink-500">Kirim Komentar</h2>
        </div>
    ...
    @auth
        ...
        <form wire:submit="submit" class="mt-5">
            ...
            <textarea
                ...
                placeholder="Bagikan pendapat, pengalaman, atau pertanyaanmu tentang postingan ini."
            ></textarea>
    ...
    @else
        <div class="mt-5 rounded-2xl border border-pink-100 bg-pink-50/70 p-5">
            ...
            <p class="mt-1 text-sm leading-6 text-gray-500">Komentar bisa dipakai untuk berbagi pengalaman, tanggapan, atau pertanyaan tentang {{ $jenis }}.</p>
    ...
    <div class="mt-7 space-y-4">
        ...
        @empty
            <div class="rounded-2xl border border-dashed border-gray-200 bg-gray-50 p-5 text-center">
                ...
                <p class="mt-1 text-xs text-gray-500">Jadilah yang pertama memulai diskusi untuk postingan ini.</p>
            </div>
        @endforelse
    </div>
</div>
